...
**Версия:** 0.1.19 · **Разработчик:** [Trifonix](https://t.me/trifonixwebsites)
...
1. **− / +** — выставить повторения. Двойной тап **+** — удалить последний подход сегодня
...
1. **− / +** — граммы (шаг 10 г). Двойной тап **+** — удалить последний приём сегодня
2. **Тап по числу** → «Вы съели N грамм?» → **Да**
3. До **5 приёмов** в день; если все 5 заняты — двойной тап **+**, затем записать заново
